...
Camera::Camera()
:m_pos(0.0, -0.1, 0.0), m_up(0.0, 1.0, 0.0), m_target(0.0, 0.0, 1.0), m_theta(0.0), m_phi(0.0), m_zoom(1.0)
{}
...
Operator::Operator()
:Proj_vec(3.0, 3.0, 1.0, 100.0), uniform_locs_set(false)
{}
...
void Operator::Set_Uniform_Locs(const Shader& sh){
    MVP_loc = sh.UniformLoc("u_MVP");
    Norm_loc = sh.UniformLoc("u_Normal");
